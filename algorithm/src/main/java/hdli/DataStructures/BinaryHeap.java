    ...
    public class BinaryHeap
    {
        ...
        {
            currentSize = 0;
            array = new java.lang.Comparable[ capacity + 1 ];
        }
         ...
         */
        public void insert( java.lang.Comparable x ) throws Overflow
        {
            if( isFull( ) )
                throw new Overflow( );
        ...
        public java.lang.Comparable deleteMin( )
        {
            ...
            java.lang.Comparable minItem = findMin( );
        ...
        private java.lang.Comparable[ ] array; // The heap array
        ...
        {
/* 1*/      int child;
/* 2*/      java.lang.Comparable tmp = array[ hole ];
