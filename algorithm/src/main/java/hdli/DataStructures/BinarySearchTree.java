...
public class BinarySearchTree {
	 ...
	 */
	private java.lang.Comparable elementAt(BinaryNode t) {
	 ...
	 * @return the new root.
	 */
	private BinaryNode insert(java.lang.Comparable x, BinaryNode t) {
		/* 1*/
		if (t == null)
			/* 2*/
	 ...
	 * @return the new root.
	 */
	private BinaryNode remove(java.lang.Comparable x, BinaryNode t) {
		if (t == null)
	 ...
	 */
	private BinaryNode find(java.lang.Comparable x, BinaryNode t) {
		if (t == null)
			return null;
		if (x.compareTo(t.element) < 0)
