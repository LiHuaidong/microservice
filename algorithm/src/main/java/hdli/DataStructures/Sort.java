...
/* 1*/      for( int p = 1; p < a.length; p++ )
            {
/* 2*/          java.lang.Comparable tmp = a[ p ];
...
/* 2*/          for( int i = gap; i < a.length; i++ )
                {
/* 3*/              java.lang.Comparable tmp = a[ i ];
/* 4*/              for( j = i; j >= gap &&
...
/* 8*/      a[ i ] = tmp;
         ...
         */
        private static void mergeSort(java.lang.Comparable[ ] a, java.lang.Comparable[ ] tmpArray,
                                      int left, int right )
        {
            if( left < right )
            {
         ...
         */
        private static void merge(java.lang.Comparable[ ] a, java.lang.Comparable[ ] tmpArray,
...
/* 1*/      if( left + CUTOFF <= right )
            {
/* 2*/          java.lang.Comparable pivot = median3( a, left, right );
...
/*13*/          insertionSort( a, left, right );
         ...
         */
        private static void quickSelect(java.lang.Comparable[ ] a, int left,
                                        int right, int k )
        {
/* 1*/      if( left + CUTOFF <= right )
            {
